...
const Footer = () => {
  return (
    <footer className="bg-white border dark:border-gray-700 dark:bg-gray-800">
      <div className="max-w-screen-2xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-3 justify-end">
            <div>
            ...
            <div>
              ...
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500 dark:text-gray-400">
                <Link className="hover:opacity-75" to="/category/technology">
                  Technology
                </Link>
                <Link className="hover:opacity-75" to="/category/lifestyle">
                  Lifestyle
                </Link>
                <Link className="hover:opacity-75" to="/category/health">
                  Health
                </Link>
              </nav>
            </div>
            <div>
              ...
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500 dark:text-gray-400">
                ...
                <Link className="hover:opacity-75" to="/support">
                  Support
                </Link>
              </nav>
            </div>
        ...
        <p className="mt-8 text-xs text-gray-800 dark:text-gray-400">
          ©{new Date().getFullYear()} Rakshith
        </p>
      </div>
    </footer>
  );
